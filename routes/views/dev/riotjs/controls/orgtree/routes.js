...
router.get('/orgtree', routes.home)
router.get('/orgtree/contents', routes.getContents)
router.get('/orgtree/js/:file', routes.getjsfile)

const init_routes = (svr) => {
    svr.route('/dev/riot/controls', router);
};
