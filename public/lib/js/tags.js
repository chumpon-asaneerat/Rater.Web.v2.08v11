...
riot.tag2('navi-drop-item', '<yield></yield>', 'navi-drop-item,[data-is="navi-drop-item"]{ position: relative; display: inline-block; margin: 2px; padding: 2px; font-size: 1.1rem; vertical-align: baseline; cursor: default; white-space: nowrap; overflow: hidden; } navi-drop-item.center,[data-is="navi-drop-item"].center{ flex-grow: 1; text-align: center; } navi-drop-item.right,[data-is="navi-drop-item"].right{ justify-self: flex-end; }', '', function(opts) {
});
riot.tag2('navi-input-item', '<yield></yield>', 'navi-input-item,[data-is="navi-input-item"]{ position: relative; display: inline-block; margin: 2px; padding: 2px; font-size: 1.1rem; vertical-align: baseline; cursor: default; white-space: nowrap; overflow: hidden; } navi-input-item.center,[data-is="navi-input-item"].center{ flex-grow: 1; text-align: center; } navi-input-item.right,[data-is="navi-input-item"].right{ justify-self: flex-end; }', '', function(opts) {
});
riot.tag2('navi-item', '<yield></yield>', 'navi-item,[data-is="navi-item"]{ position: relative; display: inline-block; margin: 2px; padding: 2px; font-size: 1.1rem; vertical-align: baseline; cursor: default; white-space: nowrap; overflow: hidden; } navi-item.center,[data-is="navi-item"].center{ flex-grow: 1; text-align: center; } navi-item.right,[data-is="navi-item"].right{ justify-self: flex-end; }', '', function(opts) {
});
riot.tag2('navibar', '<yield></yield>', 'navibar,[data-is="navibar"]{ position: relative; display: flex; align-items: baseline; justify-content: space-between; margin: 0; padding: 1px 4px; width: 100%; color: white; background: cornflowerblue; overflow: hidden; } navibar>.app-area>:not(navi-item):not(navi-drop-item):not(navi-input-item),[data-is="navibar"]>.app-area>:not(navi-item):not(navi-drop-item):not(navi-input-item){ display: none; }', '', function(opts) {
});
...
riot.tag2('statusbar', '<yield></yield>', 'statusbar,[data-is="statusbar"]{ position: relative; display: block; margin: 0; padding: 0; width: 100%; overflow: hidden; }', '', function(opts) {
});
