...
riot.tag2('app', '<h1 class="header1">In app header 1</h1> <h1 class="header1">In app header 2</h1> <div class="subitem"> <yield></yield> </div>', 'app,[data-is="app"]{ margin: 0; padding: 0; } app>.header1,[data-is="app"]>.header1{ margin: 0; padding: 0; color: red; } app>.subitem,[data-is="app"]>.subitem{ margin: 0; padding: 0; }', '', function(opts) {
});
